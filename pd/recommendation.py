...
def getOutput(messages):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "You give personalised recommendation"},
            {"role": "system", "content": "The recomendations should be based on age,location and sex"},
...
def getRecommendation(name, age, location):
    out = getOutput([
        {"role": "user", "content": f"My name is {name}, I'm from {location} and my age is {age}"},
    ])
