...
class Prediction(models.Model):
    ...
    segmentedImage = models.ImageField(
        upload_to='segmented', default=None, null=True, blank=True)
    recommendation = models.CharField(max_length=3000, default="")
    chances = models.FloatField(default=0)
